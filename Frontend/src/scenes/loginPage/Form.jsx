  ...
  return (
    <div className="form-container">
          ...
          <div className="form-input">
            ...
            <label
              className={`label-name ${
                ...
                firstNameIsFocused || firstNameInputValue !== ""
                  ? "focused"
                  : ""
              }`}
              htmlFor="firstName"
          ...
          <div className="form-input">
            ...
            <label
              className={`label-name ${
                ...
                lastNameIsFocused || lastNameInputValue !== "" ? "focused" : ""
              }`}
              htmlFor="lastName"
            >
              Last Name
          ...
          <div className="form-input">
            ...
            <label
              className={`label-name ${
                ...
                locationIsFocused || locationInputValue !== "" ? "focused" : ""
              }`}
              htmlFor="location"
            >
              Location
          ...
          <div className="form-input">
            ...
            <label
              className={`label-name ${
                ...
                occupationIsFocused || occupationInputValue !== ""
                  ? "focused"
                  : ""
              }`}
              htmlFor="occupation"
            ...
            >
              {({ getRootProps, getInputProps }) => (
                <FlexBetween className="mypost-imgdrop-div">
                  <div {...getRootProps()} className="mypost-addImg">
                    <input {...getInputProps()} />
                    {!picture ? (
                      <p>Add Image Here</p>
                    ) : (
      ...
      <div className="form-input">
        ...
        />
        <label
          className={`label-name ${isDarkTheme ? "dark-mode" : "light-mode"} ${
            emailIsFocused || emailInputValue !== "" ? "focused" : ""
          }`}
          htmlFor="email"
        >
          Email
        </label>
        <div className="error-message">{/* Display error message here */}</div>
      </div>
      ...
      <div className="form-input">
        ...
        <label
          className={`label-name ${isDarkTheme ? "dark-mode" : "light-mode"} ${
            passwordIsFocused || passwordInputValue !== "" ? "focused" : ""
          }`}
          htmlFor="password"
        >
          Password
